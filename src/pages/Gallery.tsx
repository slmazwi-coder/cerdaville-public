...
const galleryImages = [
  ...
  { src: '/assets/gallery/gallery3.jpg', caption: 'Cedarville view from school', category: 'Campus' },
    ...
    <div className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-500 max-w-xl mx-auto mb-10 -mt-4">
          A glimpse into life at Cedarville Public School — from the classroom to the sports field, from assembly to the community.
        </p>
